...
while i != '0':
    ...
    while aluno in alunos:
        print("Este aluno já está cadastrado, favor informar outro nome!")
        aluno = input("Digite o nome do aluno: ")
    alunos.append(aluno)
    ...
    if resp1.upper() == gabarito[0][1]:
        acertos.append([aluno,gabarito[0][0]])
    else:
        erros.append([aluno,gabarito[0][0]])
    ...
    if resp2.upper() == gabarito[1][1]:
        acertos.append([aluno, gabarito[1][0]])
    else:
        erros.append([aluno, gabarito[1][0]])
    ...
    if resp3.upper() == gabarito[2][1]:
        acertos.append([aluno, gabarito[2][0]])
    else:
        erros.append([aluno, gabarito[2][0]])
    ...
    if resp4.upper() == gabarito[3][1]:
        acertos.append([aluno, gabarito[3][0]])
    else:
        erros.append([aluno, gabarito[3][0]])
    ...
    if resp5.upper() == gabarito[4][1]:
        acertos.append([aluno, gabarito[4][0]])
    else:
        erros.append([aluno, gabarito[4][0]])
    ...
    if resp6.upper() == gabarito[5][1]:
        acertos.append([aluno, gabarito[5][0]])
    else:
        erros.append([aluno, gabarito[5][0]])
    ...
    if resp7.upper() == gabarito[6][1]:
        acertos.append([aluno, gabarito[6][0]])
    else:
        erros.append([aluno, gabarito[6][0]])
    ...
    if resp8.upper() == gabarito[7][1]:
        acertos.append([aluno, gabarito[7][0]])
    else:
        erros.append([aluno, gabarito[7][0]])
    ...
    if resp9.upper() == gabarito[8][1]:
        acertos.append([aluno, gabarito[8][0]])
    else:
        erros.append([aluno, gabarito[8][0]])
    ...
    if resp10.upper() == gabarito[9][1]:
        acertos.append([aluno, gabarito[9][0]])
    else:
        erros.append([aluno, gabarito[9][0]])

    
    i = input("Deseja digitar as notas de outro aluno? Caso deseje sair digite 0: ")
    while i not in "01":
        i = input("Valor inválido, digite 1 para seguir com outro cadastro ou 0 para sair: ")
